...
ARG JAVA_VERSION=17
ARG CLOJURE_VERSION=1.11.1.1165
ARG CLOJURE_LSP_VERSION=2022.10.05-16.39.51
ARG BABASHKA_VERSION=1.0.164
ARG CLJ_KONDO_VERSION=2022.10.14
ARG NODE_VERSION=16.x
ARG PLANTUML_VERSION=1.2022.8
ARG YARN_VERSION=1.22.19
ARG JDT_LSP_VERSION=1.16.0
ARG JDT_LSP_BUILD=202209291445
